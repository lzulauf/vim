...
let colors_name = "lukesorceror"

hi Normal       guifg=#c2c2b0 guibg=#202020 gui=NONE
hi ColorColumn  guifg=#ff6a6a guibg=#1a1a1a gui=NONE
...
" My trim
hi StatusLine   guifg=#d6e770 guibg=#323035  gui=bold
hi StatusLineNC guifg=#71b0de guibg=#323035  gui=bold
hi VertSplit    guifg=#323035 guibg=#323035  gui=NONE
...
" Luke's custom stuff
hi Bracket      guifg=#90b0d1
hi cppFuncCall  guifg=#71b0de
hi cppFuncDef   guifg=#c6c27e gui=bold
